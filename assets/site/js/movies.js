...
async function makeGames(category) {
  ...
  matchingCategories.forEach((item) => {
    ...
    game.id = item.id;
    game.style.backgroundImage = `url('https://cdn.jsdelivr.net/gh/Wande-inc/ETERNAL@main/assets/movies/${item.id}/img.${item.img}')`;
...
function openGame(gameId, img, name = "loading...") {
  ...
  gameHolder.innerHTML = `<div id="iframeDetails"><div><img id="iframeImg" src="https://cdn.jsdelivr.net/gh/Wande-inc/ETERNAL@main/assets/movies/${gameId}/img.${img}">
  </img>
...
async function openIframe(
  ...
  let iframeUrl = `https://cdn.jsdelivr.net/gh/Wande-inc/ETERNAL@main/assets/movies/${id}/index.html`;
